    ...
    return (
        ...
        <>
            ...
            <div className='flex flex-col '>
                ...
                <div className='border-[var(--color-darkgray)] border-solid border rounded-3xl p-4 max-md:p-2 pb-6 flex flex-col gap-4 m-3 max-md:m-0 max-md:mb-2'>
                    <img className='rounded-2xl w-full h-auto border-[var(--color-gray)] border-solid border' src={JlugSummerSS2} alt="" />
                    <div className='flex flex-col gap-5 mx-auto w-[90%]'>
                        <p className='font-[600] text-[var(--color-maintext)] text-2xl '>JEC Linux Users Group Summer School Website</p>
                        <p className=' text-sm text-[var(--color-sidetext)] mt-[-10px]'>Developed a web platform as part of a team that enables users to register for workshops, access detailed information about them, and submit feedback or reviews.</p>
                        <span>
                            <button className='bg-[var(--color-darkgray)] text-[var(--color-maintext)] rounded-2xl px-6 py-3 h-full font-[500] text-md'>View Project &gt;</button>
                        </span>
                    </div>
                ...
                <div className='border-[var(--color-darkgray)] border-solid border rounded-3xl p-4 max-md:p-2 pb-6 flex flex-col gap-4 m-3 max-md:m-0 max-md:mb-2'>
                    ...
                    <div className='flex flex-col gap-5 mx-auto w-[90%]'>
                        <p className='font-[600] text-[var(--color-maintext)] text-2xl '>NoteBloc Landing Page</p>
                        <p className=' text-sm text-[var(--color-sidetext)] mt-[-10px]'>Its a Landing Page with minimalistitc designa and animations providing the users all the necesaary information about the product</p>
                        <span>
                            <button className='bg-[var(--color-darkgray)] text-[var(--color-maintext)] rounded-2xl px-6 py-3 h-full font-[500] text-md'>View Project &gt;</button>
                        </span>
                    </div>
