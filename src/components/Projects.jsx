                ...
                <AnimatePresence>
                    {
                        !isExpanded ?
                            (<motion.div
                                className="border-[red] border-solid border rounded-3xl p-4 max-md:p-3 pb-6 flex flex-col max-md:pb-5 gap-4 m-3 max-md:m-0 max-md:mb-2"
                            >
                                ...
                                <div className='flex flex-col gap-5 mx-auto w-[90%]'>
                                    ...
                                    <span>
                                        <button onClick={() => (setIsExpanded(!isExpanded))} className='bg-[var(--color-darkgray)] text-[var(--color-maintext)] rounded-2xl px-6 py-3 h-full font-[500] text-md max-md:text-sm'>View Project &gt;</button>
                                    </span>
                                </div>
                            </motion.div>)
                            : 
                            (<motion.div
                                className="border-[#2f00ff] bg-[var(--color-darkgray)] fixed h-[70vh] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[60vw] border-solid border rounded-3xl p-4 max-md:p-3 pb-6 flex flex-col max-md:pb-5 gap-4 m-3 max-md:m-0 max-md:mb-2"
                            >
                                {/* <img className='rounded-2xl w-full h-auto border-[var(--color-gray)] border-solid border' src={JlugSummerSS2} alt="" /> */}
                                <div className='flex flex-col gap-5 mx-auto w-[90%]'>
                                    <p className='font-[600] text-[var(--color-maintext)] text-2xl max-md:text-xl '>JEC Linux Users Group Summer School Website</p>
