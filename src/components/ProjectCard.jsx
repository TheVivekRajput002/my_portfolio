    ...
    return (
        <div>
            <div className='flex gap-2 my-3 max-md:flex-col-reverse'>
                ...
                <Phone PhoneWidth={`w-[330px]`} PhoneHeight={`h-[670px]`} WebUrl={Url} />
                ...
                <div className='space-y-1'>
                    ...
                    <div className='rounded-xl border-solid border-1 border-blue-950 p-2 bg-black my-1'>
                        ...
                        <img src={SS} alt="" className='w-[100%] mb-1 rounded-lg border-[#131313] border-solid border-[0.5px]' />
                    </div>
            ...
            <div className=' my-10 h-[0.1px] w-[80%] bg-[#fff] '></div>
