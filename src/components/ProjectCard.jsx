        ...
        <div>
            <div className='flex gap-2 my-3 max-md:flex-col-reverse'>
                ...
                <div className='space-y-2'>
                    ...
                    <div className="py-4 px-5 bg-[var(--color-projectcardbg)] rounded-xl hover:scale-101 shadow-lg hover:shadow-xl">
                        <p className='font-[600] text-[var(--color-maintext)] text-4xl max-md:text-xl'>{Head}</p>
                        <button className='bg-[var(--color-lightgray)] mt-3 text-[var(--color-maintext)] rounded-2xl px-6 py-3 h-full font-[500] text-sm max-md:text-sm hover:shadow-md hover:scale-101'>View Project &gt;</button>
                    </div>

                    <div className='rounded-xl p-2 bg-[var(--color-projectcardbg)] shadow-sm hover:shadow-lg hover:scale-101'>
                        <img src={SS} alt="" className='w-[100%] mb-1 rounded-lg border-[var(--color-darkgray)] border-solid border-[0.5px]' />
                    </div>

                    <div className='p-4 bg-[var(--color-projectcardbg)] rounded-xl shadow-sm hover:shadow-lg hover:scale-101'>
