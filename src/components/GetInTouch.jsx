            ...
            <form action="" >
                <fieldset className='flex flex-col gap-3 max-md:gap-2'>
                    <div className='w-100% flex max-md:flex-col gap-3 max-md:gap-2'>
                        <input name='Name' type="text" placeholder='Full Name' className=' bg-[var(--color-darkgray)] h-14 w-[50%] max-md:w-[100%] text-md font-[500] text-[var(--color-maintext)] p-3 border rounded-2xl border-[var(--color-gray)]' />
                        <input name='Email' type="email" placeholder='Email Address' className='  bg-[var(--color-darkgray)] h-14 w-[50%] max-md:w-[100%] text-md font-[500] text-[var(--color-maintext)] p-3 border rounded-2xl border-[var(--color-gray)]' />
