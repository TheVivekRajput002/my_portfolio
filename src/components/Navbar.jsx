  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="md:hidden fixed top-3 left-1/2 -translate-x-1/2 flex items-center gap-4 px-4 py-4 rounded-3xl transparent-2 bg-[var(--color-navbg)] border border-[var(--color-darkgray)] ">
        ...
        {/* Call to Action */}
        {/* <button onClick={() => setIsDark(!isDark)} target="_blank"
        className="ml-auto bg-[black] text-white px-3 py-2 rounded-2xl hover:bg-gray-800 transition">
        Mode
      </button> */}
